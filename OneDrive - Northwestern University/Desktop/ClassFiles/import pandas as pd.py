...
# Load the CSV file
data = pd.read_csv('c:/Users/tpw3615/OneDrive - Northwestern University/Desktop/ClassFiles/NU-VIRT-DATA-PT-08-2023-U-LOLC/02-Homework/03-Python/Starter_Code/PyBank/Resources/budget_data.csv')
